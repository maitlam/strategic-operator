...
What a team knows about its market. Four skills.
...
Two disciplines everything here shares. **Observation and inference stay visibly separate** — this material circulates and loses its caveats, and an unlabeled inference gets repeated as fact in a room where nobody can check it. And **the output ends in questions, not conclusions**; desk research supports a discovery list, not a verdict.

Most of what this domain produces is negative information — segments and targets that turned out not to matter. That's the function working, and it's worth saying out loud so the effort isn't judged on how many partners it produced.
